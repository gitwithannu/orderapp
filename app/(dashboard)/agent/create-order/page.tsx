...
export default function StorePage() {
  ...
  // ⭐ Filtering logic (auto-applies agent region)
  useEffect(() => {
    let results = stores;
      ...
      <div className="max-w-8xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <div className="flex flex-wrap gap-4 mb-6">
          ...
          <div>
            ...
            <select
              ...
              className={`border rounded px-3 py-2 ${
                isAgent ? "bg-gray-200 text-gray-500 cursor-not-allowed" : ""
              }`}
            >
          ...
          <div>
            ...
            <select
              ...
              disabled={isAgent || !selectedState}
              className={`border rounded px-3 py-2 ${
                isAgent ? "bg-gray-200 text-gray-500 cursor-not-allowed" : ""
              }`}
            >
              ...
              {currentStores.map((store: any) => (
                <tr key={store._id} className="hover:bg-gray-50">
                  ...
                  <td className="border p-2 text-center">
                    ...
                    <Link
                      href={`/agent/placed-order?storeId=${store._id}`}
                      className="px-3 py-1 bg-blue-600 text-white rounded hover:bg-blue-700 transition"
                    >
                      New Way Place Order
                    </Link>
        ...
        <div className="flex justify-between items-center mt-4">
          <p className="text-gray-600">
            ...
            {Math.min(startIndex + itemsPerPage, filteredStores.length)} of{" "}
